...
| Azure Import Export      | Microsoft.ImportExport     | Enables import of data to Azure and export of data from Azure using Import/Export service. [Learn more] [!NOTE] this is NOT the same as ZQL DB Import Export. (/azure/storage/common/storage-import-export-service).  |
